...
object SharedPreferencesManager {
    ...
    private const val KEY_LOGIN_LONGITUDE = "KEY_LOGIN_LONGITUDE"
    private const val KEY_LOGIN_LATITUDE = "KEY_LOGIN_LATITUDE"
    ...
    fun getLoginLatitude(context: Context): Float =
        getPreferences(context).getFloat(KEY_LOGIN_LATITUDE, 0.0F)

    fun getLoginLongitude(context: Context): Float =
        getPreferences(context).getFloat(KEY_LOGIN_LONGITUDE, 0.0F)

    fun saveLoginLatitude(context: Context, latitude: Double) {
        val prefs = getPreferences(context)
        prefs.edit().putFloat(KEY_LOGIN_LATITUDE, latitude.toFloat()).apply()
    }
    fun saveLoginLongitude(context: Context, longitude: Double) {
        val prefs = getPreferences(context)
        prefs.edit().putFloat(KEY_LOGIN_LONGITUDE, longitude.toFloat()).apply()
    }
