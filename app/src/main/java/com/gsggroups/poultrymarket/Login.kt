...
//                    Log.d("Login", "User ID: $userId")
                    ...
                    SharedPreferencesManager.saveLoginLatitude(
                        this,
                        response.item.propertyList[0].propertyLat
                    )
                    SharedPreferencesManager.saveLoginLongitude(
                        this,
                        response.item.propertyList[0].propertyLong
                    )
                    Log.d(
                        "save----------",
