 ...
 * Use the [SupervisorListFragment.newInstance] factory method to
...
class SupervisorListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchView = view.findViewById(R.id.supervisor_searchView)
        setupSearchView()
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SupervisorListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SupervisorListFragment().apply {
