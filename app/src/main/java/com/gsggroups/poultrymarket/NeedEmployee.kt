 ...
 * Use the [NeedEmployee.newInstance] factory method to
 * create an instance of this fragment.
 */
class NeedEmployee : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_need_employee, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val editTextSalary = view.findViewById<EditText>(R.id.salary_amount)
    ...
    companion object {
         ...
         * @return A new instance of fragment NeedEmployee.
         */
